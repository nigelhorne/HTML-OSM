...
# --- SURVIVOR: COND_INV_344_2 (MEDIUM) line 344 in add_geojson() ---
# Source:  radius : integer  default 25
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_344_2 line 344 in add_geojson()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 344 in add_geojson() to detect the mutant
    fail('COND_INV_344_2: replace with real assertion');
}

# --- SURVIVOR: NUM_BOUNDARY_346_25_!= (HIGH) line 346 in add_geojson() ---
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (2 variants — one test should kill all):
#   Numeric boundary flip == to !=
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_346_25_!= line 346 in add_geojson()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 346 in add_geojson() to detect the mutant
    fail('NUM_BOUNDARY_346_25_!=: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_349_5 (MEDIUM) line 349 in add_geojson() ---
# Source:  { type => integer, value => 1 }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_349_5 line 349 in add_geojson()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 349 in add_geojson() to detect the mutant
    fail('BOOL_NEGATE_349_5: replace with real assertion');
}

# --- SURVIVOR: COND_INV_357_4 (MEDIUM) line 357 in add_geojson() ---
# Source:  =cut
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_357_4 line 357 in add_geojson()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 357 in add_geojson() to detect the mutant
    fail('COND_INV_357_4: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_363_3 (MEDIUM) line 363 in add_heatmap() ---
# Source:  my $params = Params::Get::get_params(undef, \@_) || {};
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_363_3 line 363 in add_heatmap()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 363 in add_heatmap() to detect the mutant
    fail('BOOL_NEGATE_363_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_366_3 (MEDIUM) line 366 in add_heatmap() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_366_3 line 366 in add_heatmap()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 366 in add_heatmap() to detect the mutant
    fail('BOOL_NEGATE_366_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_404_2 (MEDIUM) line 404 in add_gpx() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_404_2 line 404 in add_gpx()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 404 in add_gpx() to detect the mutant
    fail('COND_INV_404_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_409_2 (MEDIUM) line 409 in add_gpx() ---
# Source:  }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_409_2 line 409 in add_gpx()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 409 in add_gpx() to detect the mutant
    fail('BOOL_NEGATE_409_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_436_2 (MEDIUM) line 436 in add_gpx() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_436_2 line 436 in add_gpx()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 436 in add_gpx() to detect the mutant
    fail('BOOL_NEGATE_436_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_459_2 (MEDIUM) line 459 in add_choropleth() ---
# Source:  my $scale = $params->{scale} || ['#ffffcc', '#a1dab4', '#41b6c4', '#2c7fb8', '#253494'];
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_459_2 line 459 in add_choropleth()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 459 in add_choropleth() to detect the mutant
...
# --- SURVIVOR: NUM_BOUNDARY_516_29_< (HIGH) line 516 in center() ---
# Source:  my $params = Params::Get::get_params('point', \@_);
# Hint:    Likely missing edge-case test (boundary value)
...
#   Numeric boundary flip > to <=
TODO: {
    local $TODO = 'Complete: NUM_BOUNDARY_516_29_< line 516 in center()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 516 in center() to detect the mutant
    fail('NUM_BOUNDARY_516_29_<: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_526_2 (MEDIUM) line 526 in center() ---
# Source:  ($lat, $lon) = @{$point};
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_526_2 line 526 in center()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 526 in center() to detect the mutant
...
# Source:  { type => integer, min => 0, max => 19 }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# --- SURVIVOR: COND_INV_571_4 (MEDIUM) line 571 in zoom() ---
# Source:  my $self = shift;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_571_4 line 571 in zoom()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 571 in zoom() to detect the mutant
    fail('COND_INV_571_4: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_576_3 (MEDIUM) line 576 in zoom() ---
# Source:  schema => {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_576_3 line 576 in zoom()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 576 in zoom() to detect the mutant
    fail('BOOL_NEGATE_576_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_580_2 (MEDIUM) line 580 in zoom() ---
# Source:  $self->{'zoom'} = $params->{'zoom'} if defined($params->{'zoom'});
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_580_2 line 580 in zoom()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 580 in zoom() to detect the mutant
    fail('BOOL_NEGATE_580_2: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_584_2 (MEDIUM) line 584 in zoom() ---
# Source:  }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_584_2 line 584 in zoom()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 584 in zoom() to detect the mutant
    fail('BOOL_NEGATE_584_2: replace with real assertion');
}

# --- SURVIVOR: COND_INV_633_3 (MEDIUM) line 633 in zoom() ---
# Source:  3. Determine map centre: caller-supplied > computed midpoint of marker bounds.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# --- SURVIVOR: COND_INV_656_5 (MEDIUM) line 656 in onload_render() ---
# Source:  my $choropleth_layers = $self->{choropleth_layers}   || [];
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_656_5 line 656 in onload_render()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 656 in onload_render() to detect the mutant
    fail('COND_INV_656_5: replace with real assertion');
}

# --- SURVIVOR: COND_INV_660_4 (MEDIUM) line 660 in onload_render() ---
# Source:  $self->{logger}->error('No map data provided') if $self->{logger};
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_660_4 line 660 in onload_render()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 660 in onload_render() to detect the mutant
    fail('COND_INV_660_4: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_661_5 (MEDIUM) line 661 in onload_render() ---
# Source:  croak 'No map data provided';
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_661_5 line 661 in onload_render()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 661 in onload_render() to detect the mutant
...
# Source:  my $js_label = _js_string($label);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  $body .= "\t\t\tL.marker([$lat, $lon]).addTo(map).bindPopup('$js_label');\n";
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (3 variants — one test should kill all):
#   Numeric boundary flip < to >
#   Numeric boundary flip < to <=
...
# Source:  my $js_prop = _js_string($prop);
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  for my $layer (@$heatmap_layers) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  my $radius = $opts->{radius} || 25;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  onEachFeature: function(f, l) {
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  var k = f.properties && f.properties['$js_key'];
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  if(!query) { alert('Please enter a valid location.'); return; }
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  # Purpose: Prevent JS injection via user-supplied labels, URLs, or property names.
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- LOW HINT: RETURN_UNDEF_349_5 line 349 in add_geojson() ---
# Source:  { type => integer, value => 1 }
...
# --- LOW HINT: RETURN_UNDEF_363_3 line 363 in add_heatmap() ---
# Source:  my $params = Params::Get::get_params(undef, \@_) || {};
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_366_3 line 366 in add_heatmap() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: new() called with no arguments as a starting point.
...
# --- LOW HINT: RETURN_UNDEF_409_2 line 409 in add_gpx() ---
# Source:  }
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_436_2 line 436 in add_gpx() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: new() called with no arguments as a starting point.
...
# --- LOW HINT: RETURN_UNDEF_459_2 line 459 in add_choropleth() ---
# Source:  my $scale = $params->{scale} || ['#ffffcc', '#a1dab4', '#41b6c4', '#2c7fb8', '#253494'];
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_526_2 line 526 in center() ---
# Source:  ($lat, $lon) = @{$point};
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_576_3 line 576 in zoom() ---
# Source:  schema => {
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_580_2 line 580 in zoom() ---
# Source:  $self->{'zoom'} = $params->{'zoom'} if defined($params->{'zoom'});
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_584_2 line 584 in zoom() ---
# Source:  }
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_661_5 line 661 in onload_render() ---
# Source:  croak 'No map data provided';
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
