...
# Source:  Requires the Leaflet.heat plugin (C<heatmap_js_url>).
...
# --- SURVIVOR: BOOL_NEGATE_363_3 (MEDIUM) line 363 in add_geojson() ---
# Source:  | Message                              | Meaning / Resolution              |
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_363_3 line 363 in add_geojson()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 363 in add_geojson() to detect the mutant
    fail('BOOL_NEGATE_363_3: replace with real assertion');
}

# --- SURVIVOR: BOOL_NEGATE_366_3 (MEDIUM) line 366 in add_geojson() ---
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
    local $TODO = 'Complete: BOOL_NEGATE_366_3 line 366 in add_geojson()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 366 in add_geojson() to detect the mutant
    fail('BOOL_NEGATE_366_3: replace with real assertion');
}

# --- SURVIVOR: COND_INV_404_2 (MEDIUM) line 404 in add_heatmap() ---
# Source:  |----------------------|----------------------------|
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
    local $TODO = 'Complete: COND_INV_404_2 line 404 in add_heatmap()';
    # NOTE: new() called with no arguments as a starting point.
    # If HTML::OSM requires constructor arguments, add them here.
    my $obj = new_ok('HTML::OSM');
    # TODO: exercise line 404 in add_heatmap() to detect the mutant
...
# Source:  my $height            = $self->{'height'} || '400px';
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  my $width             = $self->{'width'}  || '600px';
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# Source:  var icon = L.icon({ iconUrl: '$js_icon', iconAnchor: [16,32], popupAnchor: [0,-32] });
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (3 variants — one test should kill all):
#   Numeric boundary flip < to >
#   Numeric boundary flip < to <=
...
# Source:  var m = L.marker([$lat, $lon], { icon: icon }).bindPopup('$js_label');
# Hint:    Likely missing edge-case test (boundary value)
# Mutations on this line (3 variants — one test should kill all):
#   Numeric boundary flip > to <
#   Numeric boundary flip > to >=
...
# Source:  $style_js = 'style: ' . encode_json($style) . ',';
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  var choroplethColors = $colors_json;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  dashArray: '3', fillOpacity: 0.7 };
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  var lat = data[0].lat, lon = data[0].lon;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Invert condition if to unless
TODO: {
...
# Source:  && $lon >= $LON_MIN && $lon <= $LON_MAX;
# Hint:    Add tests asserting both true and false outcomes
# Mutations on this line (1 variant):
#   Negate boolean return expression
TODO: {
...
# --- LOW HINT: RETURN_UNDEF_363_3 line 363 in add_geojson() ---
# Source:  | Message                              | Meaning / Resolution              |
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
...
# --- LOW HINT: RETURN_UNDEF_366_3 line 366 in add_geojson() ---
# Hint:    Mutation survived, but impact may be minor
# Mutations on this line (1 variant):
#   Replace return expression with undef
# NOTE: new() called with no arguments as a starting point.
